...
\section{EXPERIENCE}
  ...
  \begin{itemize} \itemsep -2pt
    \item Working with HTML5, CSS3, JavaScript, and AngularJS to develop 
...
\section{SKILLS}
  \emph{Programming Languages:} JavaScript, Python, Java, and C \\
  \emph{Markup Languages:} HTML5 and \LaTeX \\
  \emph{Web Technologies:} CSS3, Sass, jQuery, and AngularJS \\
